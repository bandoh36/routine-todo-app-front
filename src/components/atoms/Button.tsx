...
const Button = styled(MuiButton, {
  shouldForwardProp: (props) =>
    ['bgColor', 'textColor', 'rounded', 'borderSize', 'borderType', 'borderColor', 'shadow'].every((prop) => prop !== props),
})<StyledButtonProps>(({ bgColor, size = 'medium', textColor, rounded, shadow, borderSize, borderType, borderColor, theme }) => ({
  '&&': {
    ...(bgColor === 'primary'
    ...
    ...(size === 'small'
      ...
      : bgColor === 'medium'
        ...
        : bgColor === 'large'
          ...
          : null),
    color: textColor,
    ...(rounded === 'circle' ? { borderRadius: '100vw' } : rounded === 'rounded' ? { borderRadius: '10px' } : { borderRadius: rounded }),
    ...(shadow === 'primary'
      ? {
    ...
    border: `${borderSize} ${borderType} ${
      borderColor === 'primary ' ? theme.palette.primary.main : borderColor === 'disable' ? theme.palette.gray.sub : borderColor
    }}`,
  },
}));
